...
| 5. Chat: transport | [~] `db/031`: `chats`, `chat_participants`, `chat_starters`; both consenting opens the chat and answers its `chat_id` (2026-09-21); the rooms — `chat/relay.ts` still 501 | [ ] |
| 6. Encryption | [ ] | [ ] |
