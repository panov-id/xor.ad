...
5. **Ворота отступов: мерить `app-kit.svg`, предупреждать о листе без кнопок** — ~30 мин.
6. **Дизайн: «type-c на час?» у края, «один» не на линии сердца** (таббар кадра 20 сделан) — ~20 мин.
