...
| **Hetzner Online GmbH** — server hosting of the node and the database; node in **Nuremberg (nbg1)** | everything kept in the database (see `article-30-register_EN.md`) | **accepted 2026-09-21**, edition 1.2 of 2026-02-16 | not needed **while the server location is in the EU**: §3(1) says "exclusively" EU/EEA, but §3(2)–(3) allow third countries with the client's consent, and appendix 3 (p. 26) promises EU-only processing only "if you have chosen a server location within the EU" | **general consent, §7(3) (p. 6):** notice in advance, 14 days to object, silence is consent, a justified objection gives a right to terminate. Appendix 3: for the EU — Hetzner Finland Oy; subcontractors in the USA (Hetzner US LLC, NTT, QTS) and Singapore (Hetzner Singapore, NTT SG1) — only for servers in those locations | ✅ accepted (LAW-5 closed 2026-09-21). Encryption at rest — of data and of backups — is **ours**, not Hetzner's, under the TOM appendix (p. 20): see open-work P4 |
...
1. Check in the Bunny panel whether **a DPA edition newer than 2022** exists with
   the SCCs. The signed v1 of 2022-12-17 has been received and examined, but it
   carries no SCC annex while §4.6 permits processing anywhere in the world — see
   [`legal-archive/bunny-dpa_EN.md`](./legal-archive/bunny-dpa_EN.md). If there is
   nothing newer: either restrict storage regions to Europe, or ask for the SCCs
   separately.
...
4. ~~**Accept the Hetzner DPA**~~ — done 2026-09-21: edition 1.2 of 2026-02-16.
   The signed copy and the TOM appendix are kept outside the repository, which is
   public and they carry the owner's address and client number.
