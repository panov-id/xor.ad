...
| `GET /inbox` | offers and conversations in one response; a count only on offers; a conversation carries one's own `span` (2026-09-23), never the other side's | **built** 2026-09-21, was: spec |
