...
> **Исторический документ.** Он фиксирует, как выбирали бэкенд в июле 2026, и
> сохранён ради причин, а не выводов: рекомендации в нём **устарели**.
> Что вышло на самом деле — свой пул узлов (Deno + Caddy на VPS), данные в
