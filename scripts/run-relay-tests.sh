...
docker run --rm \
  ...
  --ignore=test/tenancy.test.ts,test/database.test.ts,test/identity_routes.test.ts,test/session_freeze.test.ts,test/identity_sweeper.test.ts,test/queue_metrics.test.ts "$@"
