...
| **An automated pause and a link going dark with no person** (2026-09-14) | the pause ends by itself after 15 minutes and names the time, the ground and the routes; a link goes dark only on reports from two people who have posted for a while, and the venue is emailed at that moment with a way to contest; every decision says it was automatic | a person looks only on a reply or a support request; whether GDPR Art. 22 applies to a link going dark is a question for the lawyer |
| **New timestamps about a person** (2026-09-14) | moments of publications and refusals only within the last hour, at most four and six, cut on write; the date of the first publication — to the day | the first-publication date lives as long as the identity |
