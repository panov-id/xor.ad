...
#
# Env (deploy/.env.deploy): IMPROVMX_API_KEY, NAMECHEAP_API_USER/API_KEY/USERNAME/
...
: "${IMPROVMX_API_KEY:?Missing IMPROVMX_API_KEY}"
...
docker run --rm -e IMPROVMX_API_KEY="$IMPROVMX_API_KEY" \
