...
| Where | Cases | About |
|---|---|---|
| `relay/node/test` | 251 | storefronts, panel, tenancy, DSA, keys, limits, request signature, identity routes, the PIN counter, the first PIN, recovery by paper code, freezing a session, the identity sweeper |
| `testing/e2e` | 10 | the waitlist and storefront headers |
| **Total** | **261** | **about chat and feed — 0; about the request signature — 12, about step 1 — 42: routes 30, freezing 3, the sweeper 6 against a live Postgres, the shared brake 3 by the clock (2026-09-20, overnight, after the review panel)** |
