...
#
# Коды выхода: 0 — документы проверены и целы; 1 — расхождение; 3 — ни одного
# документа не нашлось. Третий тут не формальность: файлы ищутся глобом по
...
if problems:
    ...
    raise SystemExit(1)
if not checked:
    print("ни одного документа правил не нашлось — проверять было нечего, "
          "это не зелёный результат")
    raise SystemExit(3)
