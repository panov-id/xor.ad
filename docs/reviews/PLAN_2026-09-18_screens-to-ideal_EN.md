...
| 8 | The remaining clusters | 01/02/12/13 (the code large, the confirmation field above the fold), 10/20/21/22 (a segmented control for durations), 14/15/16/17 (support CTAs, stickers — no sheet yet) | I2, panel | 5 h |
