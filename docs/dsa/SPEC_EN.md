...
## 8. Entities
    ...
    statement_of_reasons
        ...
        until                   # end of the restriction; absent — indefinite (Art. 17(3)(a); added 2026-09-17, LAW-1; built 2026-09-21 by migration `relay/node/db/026_dsa_statement_until.sql` together with the `GET /statements` route; the absence of a value is what means "indefinitely", which is why the column is nullable). No territorial scope: a restriction applies across the Service
        facts
