...
| `GET /feed` | delivery by intersecting circles (a phrase in its last 65 minutes carries `soon` instead of its end, 2026-09-23), with the language, mode and age filters; what the viewer liked is not in it — it is in `GET /likes` (2026-09-17) | **spec** (named in the test map) |
