...
| **Hetzner Online GmbH** — server hosting of the node and the database, Germany | everything kept in the database (see `article-30-register_EN.md`) | **accepted 2026-09-21**, edition 1.2 of 2026-02-16 | not needed: §3 of the agreement — processing in the EU/EEA only | encryption of data and of backups at rest is ours, not Hetzner's (TOM appendix, p. 20) | ✅ accepted (LAW-5 closed 2026-09-21) |
